...
require_once('src/Google/GTrends.php');
...
print_r($gt->getRelatedSearchQueries(['Baby Food']));
print_r("\n\n");

print_r("\n\n <h1>GTrends interestOverTime</h1>\n ");
print_r($gt->interestOverTime('Baby Food'));
print_r("\n\n");

print_r("\n\n <h1>GTrends getRelatedTopics</h1>\n ");
print_r($gt->getRelatedTopics('Baby Food'));
print_r("\n\n");

print_r("\n\n <h1>GTrends interestBySubregion</h1>\n ");
print_r($gt->interestBySubregion(['Baby Food']));
print_r("\n\n");

print_r("\n\n <h1>GTrends interestByCity</h1>\n ");
print_r($gt->interestByCity(['Baby Food']));
print_r("\n\n");

print_r("\n\n <h1>GTrends interestByMetro</h1>\n ");
print_r($gt->interestByMetro(['Baby Food']));
print_r("\n\n");

print_r("\n\n <h1>GTrends suggestionsAutocomplete</h1>\n ");
print_r($gt->suggestionsAutocomplete('Baby Food'));
print_r("\n\n");
